...
<head>
    ...
    <title>Course Management - EduPro</title>
    ...
    <main class="pt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-8" data-aos="fade-up">
                ...
                <p class="mt-2 text-gray-600">Manage and monitor all courses in your platform</p>
            </div>
            ...
            <div class="mb-6 flex flex-wrap gap-4 items-center justify-between" data-aos="fade-up">
                <div class="flex flex-wrap gap-4 items-center">
                    <!-- Search -->
                    <div class="relative">
                        <input type="text" placeholder="Search courses..." class="pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent">
